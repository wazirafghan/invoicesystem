...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">MANAGE Staff <button class="btn btn-danger pull-right" onclick="del_selected()">Delete All</button> <a href="{{route('staff.create')}}" class="btn btn-info pull-right" style="margin-right: 10px">Add New</a></div>
                    <div class="col-sm-12" style="background-color: white">
                        <div class="table-responsive">
                            <form action="{{url('admin/delete-selected-staff')}}" method="post" id="uform">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <table id="staff" class="table table-hover manage-u-table table-bordered table-responsive table-striped">
                                    <thead>
                                        <tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function del_selected(){
            swal({
                title: "Are you sure?",
                text: "These Staff will be deleted permanently",
                type: "info",
                showCancelButton: true,
                closeOnConfirm: false,
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("Staff deleted sucessfully. Thanks");
                }, 2000);
            });
        }
    </script>
    ...
    <script>
        ...
        var users = $('#staff').DataTable( {
            "processing": true,
            "serverSide": true,
            "responsive": true,
            "ajax": {
                "url":"{{ route('admin.getStaff') }}",
                "dataType":"json",
                "type":"POST",
