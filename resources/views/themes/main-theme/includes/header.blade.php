...
{{--                <a href="#">settings</a>--}}
                ...
                <div class="login_credential" style="float:right;">
                    <a href="{{url("/login")}}" title="Login" id="login"><i class="fa fa-sign-in full-right"></i> SIGN IN </a>
                    <a href="{{url("/register")}}" title="Register Here" class="btn-register" id="sigup-button">
                        <i class="fa fa-user full-right"></i>  SIGN UP </a>
                </div>
