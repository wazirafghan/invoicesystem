...
<table width="100%" cellspacing="50" cellpadding="50" border="0" bgcolor="#E7E7E7" class="wrapper">
    ...
    <tr>
        <td>
                    ...
                    <td>
                        <table>
                            <tr style="text-align:center">
                                <td><img style="width:200px !important;" src="{{ asset('uploads/'.$logo) }}" /></td>
                            </tr>
            ...
            <p style="text-align:center; margin:35px auto 0px; font-size:14px; color:#5d5d5d; width:500px; line-height:25px;" >This email was intended for www.inetventures.co.uk admininistrator.
                © {{ date('Y') }} www.inetventures.co.uk</p>
        </td>
    </tr>
